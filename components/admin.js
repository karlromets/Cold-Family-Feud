    ...
    return (
      ...
      >
        <div className="min-h-full">
          {/* ROOM CODE TEXT */}
          <p id="roomCodeText" className="text-center text-8xl p-4 font-semibold uppercase text-foreground">
            {props.room}
          </p>
          <hr />
          <div className="flex flex-row justify-evenly p-5 ">
            ...
            >
              <div className="hover:shadow-md rounded bg-failure-200 p-2 w-32 flex justify-center">{t('Quit')}</div>
            </button>
          </div>
        ...
        {game.rounds == null ? (
          <p className="text-2xl text-center py-20 text-secondary-900">[{t('Please load a game')}]</p>
        ) : (
          <div>
            <div className="flex-col space-y-5 p-5">
              ...
              <div className="flex flex-row justify-evenly items-baseline">
                <TitleMusic />
                {/* CURRENT SCREEN TEXT */}
                <p id="currentScreenText" className="text-2xl text-center pt-5 text-foreground">
                  {' '}
            ...
            {!game.is_final_round ? (
                ...
                <div className="flex flex-col space-y-2 px-10 pt-5">
                  ...
                  <div className="flex flex-row border-4 p-2 space-x-5 items-center justify-between">
                    <div className="flex flex-row space-x-5 items-center">
                      ...
                      <h3 id="pointsNumberText" className="text-2xl flex-grow  text-foreground">
              ...
              <div>
                ...
                <div className="p-5">
                  {/* FINAL ROUND TEXT */}
                  <h2 id="finalRoundNumberText" className="text-6xl py-5 text-center text-foreground">
                  ...
                  <div className="flex py-5 items-center flex-row justify-evenly space-x-5">
                    ...
                    <div className="px-2 flex">
                      ...
                      <button
                        className={`border-4 rounded p-5 ml-2 text-3xl bg-secondary-300 text-foreground ${
                          !timerStarted ? '' : 'opacity-50'
                        }`}
                        disabled={timerStarted}
                        id="resetTimerButton"
